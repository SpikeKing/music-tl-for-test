...
from training.audio.audio_dir import ROOT_DIR, DATA_DIR
from training.audio.data_loaders.data_augment import get_feature
from training.audio.utils.utils import sort_two_list
from training.audio.utils.config_utils import process_config
...
class DistanceApi(object):
    def __init__(self):
        ...
        self.model = None
        self.config = process_config(os.path.join(ROOT_DIR, 'configs', 'triplet_config.json'))
        pass
    ...
    def init_mode(self):
        ...
        sym = os.path.join(DATA_DIR, "triplet_net.json")
        params = os.path.join(DATA_DIR, "triplet_loss_model_88_0.9934.params")
